...
#   Change Prompt
#   ------------------------------------------------------------
    export PS1="${BGreen}\u${BBlue}@${BRed}\h${BBlue}{\w}${BYellow}\$(git_branch)${BGreen}:${RESET} "

#   Set Paths
#   ------------------------------------------------------------
    export PATH="$PATH:/usr/local/bin:$HOME/.composer/vendor/bin:$HOME/.rvm/bin"
...
#   -----------------------------
    ...
    alias sshkey="cat ~/.ssh/id_rsa.pub | pbcopy && echo 'Copied to clipboard.'" # sshkey: Copy SSH key to clipboard
...
#   -------------------------------------------------------------------
    ...
    alias v:down='vagrant destroy'

    alias h:edit="homestead edit"
    alias h:up="homestead up"
    alias h:halt="homestead halt"
    alias h:ssh="homestead ssh"
    alias h:du="homestead destroy && homestead up"
